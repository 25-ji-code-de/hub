// @sekai-vendor @25-ji-code-de/sekai-auth@v0.2.0 dist/sekai-auth.mjs
/*
 ...
 * @returns {SekaiAuth}
 */
export function createSekaiAuth(options) {
  return new SekaiAuth(options);
}

/** SEKAI Pass 生产环境端点。 */
export const SEKAI_PASS_ENDPOINTS = Object.freeze({
...
export const SEKAI_PASS_ISSUER = 'https://id.nightcord.de5.net';
