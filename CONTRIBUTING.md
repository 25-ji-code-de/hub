...
本项目是 SEKAI 生态的核心门户。查看完整的项目列表: **[SEKAI Hub](https://hub.nightcord.de5.net)**
...
# 添加上游仓库
git remote add upstream https://github.com/25-ji-code-de/hub.git
```
...
- 浏览现有的 [Issues](https://github.com/25-ji-code-de/hub/issues)
- 在 Issue 中提问
- 查看其他 SEKAI 生态项目的实现
